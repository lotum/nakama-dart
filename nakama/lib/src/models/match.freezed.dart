...
extension MatchPatterns on Match {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Match() when $default != null:
        return $default(_that.matchId, _that.authoritative, _that.label,
            _that.size, _that.tickRate, _that.handlerName, _that.presences);
      case _:
        return orElse();
    }
  }
...
mixin _$Party {
  ...
  int get hashCode => Object.hash(runtimeType, partyId, open, maxSize, self,
      leader, const DeepCollectionEquality().hash(presences));
...
extension PartyPatterns on Party {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Party() when $default != null:
        return $default(_that.partyId, _that.open, _that.maxSize, _that.self,
            _that.leader, _that.presences);
      case _:
        return orElse();
    }
  }
