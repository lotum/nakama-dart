...
extension AccountPatterns on Account {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Account() when $default != null:
        return $default(_that.wallet, _that.email, _that.devices,
            _that.customId, _that.verifyTime, _that.disableTime, _that.user);
      case _:
        return orElse();
    }
  }
...
mixin _$Device {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, const DeepCollectionEquality().hash(vars));
...
extension DevicePatterns on Device {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, Map<String, dynamic>? vars)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _Device extends Device {
  const _Device({required this.id, final Map<String, dynamic>? vars})
      : _vars = vars,
        super._();
